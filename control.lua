...
local Interface = require('__stdlib2-continued__/stdlib/scripts/interface').merge_interfaces(require('interface'))
...
local Player = require('__stdlib2-continued__/stdlib/event/player').register_events(true)
require('__stdlib2-continued__/stdlib/event/force').register_events(true)
require('__stdlib2-continued__/stdlib/event/changes').register_events('mod_versions', 'changes/versions')
