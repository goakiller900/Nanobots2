...
local Interface = require('__kry_stdlib__/stdlib/scripts/interface').merge_interfaces(require('interface'))
...
local Player = require('__kry_stdlib__/stdlib/event/player').register_events(true)
