...
Data {
    type = 'item',
    name = 'equipment-bot-chip-items',
    icon = '__Nanobots2-continued__/graphics/icons/equipment-bot-chip-items.png',
    icon_size = 64,
...
local equipment_chip =
    ...
    sprite = {
        filename = '__Nanobots2-continued__/graphics/equipment/equipment-bot-chip-items.png',
        width = 64,
        height = 64,
        priority = 'medium',
        scale = 0.5
