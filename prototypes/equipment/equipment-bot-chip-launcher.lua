...
Data {
    type = 'item',
    name = 'equipment-bot-chip-launcher',
    icon = '__Nanobots2-continued__/graphics/icons/equipment-bot-chip-launcher.png',
    icon_size = 64,
...
local equipment_chip =
    ...
    sprite = {
        filename = '__Nanobots2-continued__/graphics/equipment/equipment-bot-chip-launcher.png',
        width = 64,
        height = 64,
        priority = 'medium',
        scale = 0.5
