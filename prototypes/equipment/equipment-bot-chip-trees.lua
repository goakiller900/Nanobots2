...
Data {
    type = 'item',
    name = 'equipment-bot-chip-trees',
    icon = '__Nanobots2-continued__/graphics/icons/equipment-bot-chip-trees.png',
    icon_size = 64,
...
local equipment_chip =
    ...
    sprite = {
        filename = '__Nanobots2-continued__/graphics/equipment/equipment-bot-chip-trees.png',
        width = 64,
        height = 64,
        priority = 'medium',
        scale = 0.5
